...
!["A selection of 8 similar looking photos of Uluru with various lighting and framing"](uluru_sunset.jpg "Which one is better?")
...
<figure class="figure w-100">
 <img src="global_distribution.png" alt="Normalized distribution of ratings across the entire AVA dataset.">
 <img src="global_histogram.png" alt="Weighted average histogram of calculated scores across the entire AVA dataset.">
 <img src="global_rating_votes.png" alt="Mean number of votes, and std dev, per rating across the entire AVA dataset.">
...
<a class="lightbox-link" href="normalized_dist_tag.png" data-lightbox="normalized_dist_tag" data-title="Normalized Distribution of Ratings Per Tag">normalized distribution of ratings per tag</a>
, and the
...
![A list of all the tags present in the AVA dataset presented in descending order by number of associated photos](photo_dist_tag_first.png "Fig 3. Photo distribution across each tag showcasing the severe lack of representation of niche topics.")
...
![A random sampling of the images in the dataset, showcasing the calculated weighted average, and associated tags, with each image.](random_sample_images.png "Fig 4. Randomly sampled 12 images from the entire dataset along with their weighted average and associated tags. The two black and white photos in the top right only appear that way due to the way matplotlib displays single channel images. ")
...
<figure class="figure w-100">
 <div class="container">
  <div class="row">
   <div class="col">
                <img src="photo_dist_challenge_top.png" alt="A list of the top 70 most popular challenges in the AVA dataset presented in descending order by number of photo submissions." caption="Top 70 challenges by photo submissions.">
   </div>
   <div class="col">
                <img src="photo_dist_challenge_bot.png" alt="A list of the bottom 70 least popular challenges in the AVA dataset presented in descending order by number of photo submissions." caption="Bottom 70 challenges by photo submissions.">
   </div>
  </div>
 </div>
...
![Weighted average histograms of the calculated scores for the Vanish, Raod_Signs, Table_Shot, Homemade_Landscapes_II, Painted_Face, and Practical_Jokes challenges.](unique_weighted_avg_hist_challenges.png "Fig 7. Example of non-contiguous histograms for challenges with low submissions.")
...
<a class="lightbox-link" href="normalized_dist_challenge_top.png" data-lightbox="normalized_dist_challenge_top" data-title="Normalized Distribution of Ratings for Top 70 Challenges">rating distributions</a>
 and
 <a class="lightbox-link" href="weighted_avg_hist_challenge_top.png" data-lightbox="weighted_avg_hist_challenge_top" data-title="Weighted Avg Histogram for Top 70 Challenges">histograms</a>
 follow the same curve as described in Figure 1. While, as previously predicted, the Bottom 70’s
 <a class="lightbox-link" href="normalized_dist_challenge_bot.png" data-lightbox="normalized_dist_challenge_bot" data-title="Normalized Distribution of Ratings for Bottom 70 Challenges">rating distributions</a>
 are more flat and, as shown in Figure 7, the
  <a class="lightbox-link" href="weighted_avg_hist_challenge_bot.png" data-lightbox="weighted_avg_hist_challenge_bot" data-title="Weighted Avg Histogram for Bottom 70 Challenges">histograms</a>
...
![A distribution of voting averages that shows the mean and standard deviation of ratings given in the Black__White_III, Free_Study_2007-12, Branch, and Best_Of_2010 challenges.](mean_ratings_challenge_top_example.png "Fig 8. Example of mean/std of individual rating votes for the most popular challenges.")
...
![A distribution of voting averages that shows the mean and standard deviation of ratings given in the Homemade_Landscapes_II, Painted_Face, Practical_Jokes, Thar_Be_Pirates challenges.](mean_ratings_challenge_bot_example.png "Fig 9. Mean/Std of votes per rating for the bottom 70 Challenges by photo submissions.")
...
<figure class="figure w-100">
 <div class="container">
  <div class="row">
   <div class="col">
                <img src="avg_votes_challenge_top.png" alt="A list of the top 70 most popular challenges in the AVA dataset presented in descending order by number of photo submissions, showcasing the average votes per photo with standard deviation." caption="Mean, and standard deviation, of votes in the top 70 challenges by photo submissions.">
   </div>
   <div class="col">
                <img src="avg_votes_challenge_bot.png" alt="A list of the bottom 70 least popular challenges in the AVA dataset presented in descending order by number of photo submissions, showcasing the average votes per photo with standard deviation." caption="Mean, and standard deviation, of votes in the bottom 70 challenges by photo submissions.">
   </div>
  </div>
 </div>
